export const CountDown = () => {
	...
	const howManyDays = () => {
		...
		const diffDay: number = Math.floor((geikosaiDate.getTime() - nowDate.getTime()) / 86400000);
		return diffDay
	}
	...
	return (
		<>
			<p>
				芸工祭まで<span style={{ margin: '12px', fontFamily: 'Pixel', fontSize: '32px' }}>{howManyDays()}</span>日
			</p>
		</>
	)
}